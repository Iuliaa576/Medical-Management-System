...
public class JSONFileRepositoryTests {
    ...
    private static final String PATIENT_FILE = "test_patients.json";
    private static final String APPOINTMENT_FILE = "test_appointments.json";

    private PatientRepositoryJSONFile patientRepo;
    private AppointmentRepositoryJSONFile appointmentRepo;
    ...
    void setUp() throws RepositoryException {
        ...
        patientRepo = new PatientRepositoryJSONFile(PATIENT_FILE);
        appointmentRepo = new AppointmentRepositoryJSONFile(APPOINTMENT_FILE);
    }
    ...
    void testPatientAddAndPersistence() throws RepositoryException {
        ...
        // Reload and verify
        PatientRepositoryJSONFile reloaded = new PatientRepositoryJSONFile(PATIENT_FILE);
    ...
    void testPatientDeleteAndPersistence() throws RepositoryException {
        ...
        List<Patient> patientsBefore = toList(patientRepo.getAll());
    ...
    void testPatientReadFromEmptyFile() throws RepositoryException, IOException {
        ...
        PatientRepositoryJSONFile emptyRepo = new PatientRepositoryJSONFile(PATIENT_FILE);
    ...
    void testPatientInvalidFileThrowsException() {
        assertThrows(RepositoryException.class, () -> {
            ...
            new PatientRepositoryJSONFile(PATIENT_FILE);
        });
    }
    ...
    void testAppointmentAddAndPersistence() throws RepositoryException {
        ...
        AppointmentRepositoryJSONFile reloaded = new AppointmentRepositoryJSONFile(APPOINTMENT_FILE);
    ...
    void testAppointmentReadFromEmptyFile() throws RepositoryException, IOException {
        ...
        AppointmentRepositoryJSONFile emptyRepo = new AppointmentRepositoryJSONFile(APPOINTMENT_FILE);
    ...
    void testAppointmentInvalidFileThrowsException() {
        assertThrows(RepositoryException.class, () -> {
            ...
            new AppointmentRepositoryJSONFile(APPOINTMENT_FILE);
        });
    }
}
